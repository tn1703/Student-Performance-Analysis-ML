...
sb.heatmap(data.corr(), annot=True, cmap="coolwarm", linewidths=0.5)
...
# ---- Student Activity Bar Graph ----

activity_means = data[['raisedhands', 'VisITedResources', 'Discussion']].mean()

plt.figure(figsize=(8,5))

activity_means.plot(kind='bar')

plt.title("Average Student Activity")
